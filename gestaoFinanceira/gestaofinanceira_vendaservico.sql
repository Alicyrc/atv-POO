...
CREATE TABLE `vendaservico` (
  `id_venda_servico` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `vendaservico_ibfk_1` FOREIGN KEY (`fk_id_servico`) REFERENCES `servicos` (`id_servico`),
  CONSTRAINT `vendaservico_ibfk_2` FOREIGN KEY (`fk_id_venda`) REFERENCES `venda` (`id_venda`) ON DELETE CASCADE
...
-- Dump completed on 2024-09-05 13:19:22
