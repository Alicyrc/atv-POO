...
CREATE TABLE `caixa` (
  ...
  `total_entradas` decimal(10,0) NOT NULL,
  `total_saidas` decimal(10,0) NOT NULL,
  `status_caixa` varchar(10) NOT NULL,
  `fk_id_funcionario` int DEFAULT NULL,
  PRIMARY KEY (`id_caixa`),
  KEY `fk_id_funcionario` (`fk_id_funcionario`),
  CONSTRAINT `caixa_ibfk_1` FOREIGN KEY (`fk_id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
...
-- Dump completed on 2024-09-05 13:19:21
