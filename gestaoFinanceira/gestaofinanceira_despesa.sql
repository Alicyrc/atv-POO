...
CREATE TABLE `despesa` (
  ...
  CONSTRAINT `despesa_ibfk_1` FOREIGN KEY (`fk_id_caixa`) REFERENCES `caixa` (`id_caixa`),
  CONSTRAINT `despesa_ibfk_2` FOREIGN KEY (`fk_id_fornecedor`) REFERENCES `fornecedores` (`id_fornecedor`)
