...
CREATE TABLE `encargo` (
  ...
  CONSTRAINT `encargo_ibfk_1` FOREIGN KEY (`fk_id_dispositivo`) REFERENCES `dispositivo` (`id_dispositivo`),
  CONSTRAINT `encargo_ibfk_2` FOREIGN KEY (`fk_id_recebimento`) REFERENCES `recebimentos` (`id_recebimento`) ON DELETE CASCADE
...
-- Dump completed on 2024-09-05 13:19:20
